...
const uk = {
  ...
  handoff: {
    ...
    patient: "Пацієнт",
    episode: "Курс відновлення",
    functionalGoal: "Функціональна ціль",
    measurementQuality: "Якість вимірювання",
    baselineComparison: "Від базового вимірювання",
    previousComparison: "Від попереднього вимірювання",
...
const en = {
  ...
  handoff: {
    ...
    patient: "Patient",
    episode: "Rehabilitation episode",
