...
TRANSLATIONS: dict = {
    "uk": {
        ...
        "rehab_disclaimer": "Відеоаналіз є тренувальним інструментом і не замінює оцінку лікаря або фізичного терапевта. За однієї камери згинання та відведення плеча вимірюються однаково — обирайте протокол за площиною зйомки.",
    ...
    "en": {
        ...
        "rehab_disclaimer": "Video analysis is a training aid and does not replace assessment by a physician or physical therapist. With a single camera, shoulder flexion and abduction are measured identically — pick the protocol that matches your recording plane.",
